...
public class RecyclerViewAdapterUser extends RecyclerView.Adapter<RecyclerViewAdapterUser.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            textViewName = v.findViewById(R.id.event_name_user);
            textViewDate = v.findViewById(R.id.event_time_user);
    ...
    public RecyclerViewAdapterUser(Context context, List<Event_list> albumList) {
    ...
    public RecyclerViewAdapterUser.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.item_listview_user, parent, false);
